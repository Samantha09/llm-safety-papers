...
│   ├── ActorAttack.md                 # ✅ ActorAttack - 基于行动者网络的多轮越狱攻击
│   ├── AutoDAN.md                     # ✅ AutoDAN
...
| 11 | [ActorAttack](./papers/ActorAttack.md) | ACL 2025 | 基于行动者网络的多轮越狱攻击（原v1标题Derail Yourself） | `多轮攻击` `行动者网络` `自发现线索` |
